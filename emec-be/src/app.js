...
import vehicleDefectRoutes from './routes/vehicleDefectRoutes.js';
import preInspectionRecommendationRoutes from './routes/preInspectionRecommendationRoutes.js';
...
app.use('/api/vehicle-defects', vehicleDefectRoutes);
app.use('/api/pre-inspection-recommendations', preInspectionRecommendationRoutes);
